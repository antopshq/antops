...
console.log('   - Go to http://localhost:3001/dashboard/changes')
...
console.log('   - Check automation status: curl http://localhost:3001/api/automation/control')
console.log('   - Trigger manual run: curl -X POST http://localhost:3001/api/cron/change-lifecycle')
